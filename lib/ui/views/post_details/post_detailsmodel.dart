  ...
  navigateToChatRoomView(ProductModel e) {
    _navigationService.navigateToChatRoomView(
        smsText: e.type == "Spare Parts"
            ...
            : "Hey ${e.saller?.name ?? ""}, I saw your spare parts listing on Car Meta app. I'm in need of ${e.title} Model:${e.model} for my [car make and model]. Could you please provide more details about its compatibility and condition? Also, let me know if it's available and how we can proceed with the purchase. Thank ",
